...
exports.gameLoop = exports.createGameState = exports.FRAME_RATE = void 0;
var FRAME_RATE = 20;
exports.FRAME_RATE = FRAME_RATE;
var BAT_HEIGHT = 100;
var CANVAS_HEIGHT = 585;
...
function createGameState() {
    return {
        players: [{
            ...
            pos: { x: 100, y: 100 }, angle: -0.25 * Math.PI, velocity: { x: 10, y: 10 }
        },
        score: { p1: 0, p2: 0 }
    };
}
...
function gameLoop(state) {
    var players = state.players, ball = state.ball, score = state.score;
    var p1 = players[0];
    var p2 = players[1];
    p1.pos += p1.velocity;
    p2.pos += p2.velocity;
...
function resetObjects(state) {
    var ball = state.ball, players = state.players;
    var p1 = players[0];
    var p2 = players[1];
